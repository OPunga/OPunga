...
I am a software engineer focused on building stable, efficient applications. 
My work mainly involves bridging the gap between performant backend logic and 
clean, user-friendly mobile interfaces. I prioritize writing code that is 
easy to maintain and built to handle growth.
...
**Open to Discuss**
Microservices, cloud infrastructure, and fintech integrations.
